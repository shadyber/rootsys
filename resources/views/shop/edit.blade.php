        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div class="card-body">
                        {{ Form::model($product, array('route' => array('shop.update', $product->id), 'method' => 'PUT')) }}
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group mt-4 mb-0"><button type="submit" class="btn btn-primary btn-block"  >Updated Product</button></div>
                        {{Form::close()}}
                    </div>
